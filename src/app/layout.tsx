import './globals.css';
export const metadata = { title: 'SiteSnap · Construction evidence', description: 'Professional site photo records for small construction teams.', manifest: '/manifest.webmanifest' };
