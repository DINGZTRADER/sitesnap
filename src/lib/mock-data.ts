...
export const photos: PhotoRecord[] = [
  base('p1', 'hackney', 'photo-1503387762-592deb58ef4e', 'after', 'Today, 11:15', 'Dave Evans', 'Foreman', 'Ground floor · Gridline 3', ['JCT Variation'], 'Steel beam clash with specified MVHR ducting. Rerouted through web opening; Variation Notice #14 issued.', 'p4'),
  ...
  base('p6', 'northampton', 'photo-1503387762-592deb58ef4e', 'after', 'Yesterday, 16:20', 'Mark Ward', 'Clerk of Works', 'Warehouse slab · Grid E4–E8', ['Daily Progress'], 'DPM and reinforcement installed across the first pour area.', 'p5'),
