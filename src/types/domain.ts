...
export type PhotoRecord = { id: string; projectId: string; image: string; timestamp: string; capturedBy: string; role: string; location: string; tags: Tag[]; note: string; syncStatus: SyncState; pairedPhotoId?: string; stage?: 'before' | 'after'; };
